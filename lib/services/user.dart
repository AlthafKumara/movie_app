  import 'dart:convert';
  import 'package:app_movie/models/response_data_map.dart';
  ...
  class UserService {
    ...
    Future<ResponseDataMap> loginUser(Map<String, String> data) async {
      var uri = Uri.parse(url.BaseUrl + "login_user");
      ...
      if (register.statusCode == 200) {
        ...
        UserLogin userLogin = UserLogin(
            ...
            token: responseData["authorisation"]
                ["token"], // Ambil token dari authorisation
